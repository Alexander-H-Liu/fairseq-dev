...
resume_ckpt=$log_root/pretrain_400k/base_discrete_v350_normtrue_k8_m0.65_cbdec0.6/ckpt/checkpoint_214_200000.pt
...
freeze_pre_enc_modules=( "true" "false" ) # freeze just transformer encoder or everything
